...
\end{thm}
\begin{proof}
    % need different notations than F_<n to indicate support in Lagrange basis,
    % as this is what we want. Also changed to be in G1 to agree with other
    % lemmas
...
\begin{proof} 
    ...
    Then, the algorithm of Feist and Khovratovich \cite{} % https://alinush.github.io/2021/06/17/Feist-Khovratovich-technique-for-computing-KZG-proofs-fast.html
